...
export const metadata: Metadata = {
  title: "Frisson — micro-interactions",
  description:
    "An open-source collection of finely detailed motion components for Next.js, built with Motion.",
};
...
export default function RootLayout({
  ...
  return (
    ...
    >
      <head>
        {/* Resolve the theme before first paint so there's no flash: use the
